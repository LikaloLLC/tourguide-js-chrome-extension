    ...
    <div className="card step">
      <div className="card-header d-flex align-items-center">
        ...
        <div className="ml-auto">
          <button className="btn btn-icon" onClick={() => props.stepRemove(props.index)}>
        ...
        <form className="card-form">
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => props.stepUpdate({ title: e.currentTarget.value }, props.index)}
            />
          </div>
          <div className="btn-group btn-group-toggle mb-1">
            <label className="btn btn-sm btn-outline-secondary active">
              <input type="radio" name="options" id="option1" checked />{' '}
              <svg className="icon-trash" width="16" height="16" viewBox="0 0 20 20">
                <path
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={(e) => props.stepUpdate({ content: e.currentTarget.value }, props.index)}
            ></textarea>
          </div>
        </form>
        <div className="form-group m-0">
          {props.step.selector !== '' ? (
            <button
              ...
              onClick={() => {
                chrome.runtime.sendMessage({ openPicker: true, step: props.index });
              }}
            >
